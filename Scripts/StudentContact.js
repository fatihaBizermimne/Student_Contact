...
function RenderContact(firstName, lastName, email, phone, address, submit){
  return Doc.Element("section", [Attr.Create("class", "section")], [Doc.Element("h2", [Attr.Create("class", "subtitle")], [Doc.TextNode("Student Contact")]), Doc.Element("p", [Attr.Create("class", "subhead")], [Doc.TextNode("A simple Website that stores, Updates and Deletes Student Contact Information")]), Doc.Element("div", [Attr.Create("class", "field")], [Doc.Element("label", [Attr.Create("class", "label")], [Doc.TextNode("First name: "), Doc.Input([Attr.Create("class", "input")], firstName)]), ShowErrorsFor(Through_1(submit.view, firstName))]), Doc.Element("div", [Attr.Create("class", "field")], [Doc.Element("label", [Attr.Create("class", "label")], [Doc.TextNode("Last name: "), Doc.Input([Attr.Create("class", "input")], lastName)]), ShowErrorsFor(Through_1(submit.view, lastName))]), Doc.Element("div", [Attr.Create("class", "field")], [Doc.Element("label", [Attr.Create("class", "label")], [Doc.TextNode("Email: "), Doc.EmailInput([Attr.Create("class", "input")], email)]), ShowErrorsFor(Through_1(submit.view, email))]), Doc.Element("div", [Attr.Create("class", "field")], [Doc.Element("label", [Attr.Create("class", "label")], [Doc.TextNode("Phone: "), Doc.Input([Attr.Create("class", "input")], phone)]), ShowErrorsFor(Through_1(submit.view, phone))]), Doc.Element("div", [Attr.Create("class", "field")], [Doc.Element("label", [Attr.Create("class", "label")], [Doc.TextNode("Address: "), Doc.Input([Attr.Create("class", "input")], address)]), ShowErrorsFor(Through_1(submit.view, address))]), Doc.Element("div", [], [Doc.Button("Submit", [Attr.Create("class", "button")], () => {
    submit.Trigger();
